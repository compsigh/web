...
export async function GET(request: Request) {
  ...
  const title = hasTitle ? searchParams.get("title") : "compsigh"
  ...
  const authorAvatarFilenamesToPermalinks: Map<string, string> = new Map([
    [
      "/avatars/andrew.png",
      "https://raw.githubusercontent.com/compsigh/web/main/public/avatars/andrew.png"
    ],
    [
      "/avatars/antoinette.png",
      "https://raw.githubusercontent.com/compsigh/web/main/public/avatars/antoinette.png"
    ],
    [
      "/avatars/calvin.png",
      "https://raw.githubusercontent.com/compsigh/web/main/public/avatars/calvin.png"
    ],
    [
      "/avatars/edward.png",
      "https://raw.githubusercontent.com/compsigh/web/main/public/avatars/edward.png"
    ],
    [
      "/avatars/gursh.png",
      "https://raw.githubusercontent.com/compsigh/web/main/public/avatars/gursh.png"
    ],
    [
      "/avatars/jet.png",
      "https://raw.githubusercontent.com/compsigh/web/main/public/avatars/jet.png"
    ],
    [
      "/avatars/quinn.png",
      "https://raw.githubusercontent.com/compsigh/web/main/public/avatars/quinn.png"
    ],
    [
      "/avatars/sanju.jpeg",
      "https://raw.githubusercontent.com/compsigh/web/main/public/avatars/sanju.jpeg"
    ]
  ])
  ...
  const authors = authorNamesParam.map((authorName, index) => {
    const authorAvatar = authorAvatarFilenamesToPermalinks.get(
      authorAvatarsParam[index]
    )
    return {
      name: authorName,
      avatar: authorAvatar
  ...
  const iAWriterQuattroRegular = await fetch(
    new URL(
      "../../../public/fonts/iAWriterQuattroS-Regular.ttf",
      import.meta.url
    )
  ).then((res) => res.arrayBuffer())
