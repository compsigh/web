...
// Original JavaScript quotes (kept for fallback compatibility)
...
// Enhanced version using Rust utilities (server-side only)
export function RustPoweredQuote({ quote }: { quote: Quote }) {
  return (
    <>
      <div
        id={styles["quote-container"]}
        style={{
          // More sophisticated rotation using Rust's secure random
          transform: `rotate(${Math.random() * 20 - 10}deg)`
        }}
      >
        <blockquote>
